# https://github.com/avinashpaliwal/Super-SloMo/blob/master/data/create_dataset.py
...
parser.add_argument("--dataset", type=str, default="adobe240fps",  # default="custom",
                    help='specify if using "adobe240fps" or custom video dataset')
parser.add_argument("--videos_folder", type=str, default=proj_dir("datasets", "adobe240fps", "raw"),
                    help='path to the folder containing videos')
parser.add_argument("--dataset_folder", type=str, default=proj_dir("datasets", "adobe240fps"),
...
def extract_frames(videos, inDir, outDir):
    ...
    for video in videos:
        ...
        retn = os.system(
            '{} -i {} -vf scale={}:{} -vsync 0 -qscale:v 2 {}/%04d.jpg'.format(
                args.ffmpeg,
